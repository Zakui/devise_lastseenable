...
module DeviseLastseenable
  module Generators
    ...
    class InstallGenerator < Rails::Generators::Base
      ...
      desc "Creates a DeviseLastseenable initializer and copy locale files to your application."
      class_option :orm

      def copy_initializer
        unless options[:orm]
          raise MissingORMError, <<-ERROR.strip_heredoc
          An ORM must be set to install DeviseLastseenable in your application.
